...
const TestimonialItem = ({ item }) => {
  return (
    <div className="px-5 py-8 border shadow-sm border-neutral-200 rounded-xl">
      <div className="flex flex-col justify-center">
        <div className="flex items-center justify-center">
          <Image
            className="object-cover h-[6.25rem] w-[6.25rem] rounded-xl"
            src={item?.image}
            width={1000}
            height={750}
            placeholder="blur"
        ...
        <div className="my-5 text-center">
          <p className="text-[#9D9D9D]">{item?.msg}</p>
          <h3 className="text-[1.625rem] leading-[2.438rem] mt-2 mb-1">
            {item?.name}
          </h3>
